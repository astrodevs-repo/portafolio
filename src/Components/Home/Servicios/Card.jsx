...
const Card = ({ title, content, svg, index, expanded, onExpand }) => {
  return (
    <motion.article
      className="relative bg-blackCeniza dark:bg-gray-900 h-full w-full rounded-md overflow-hidden hidden sm:hidden md:flex flex-col justify-center items-center gap-10 px-20 py-10 cursor-pointer"
