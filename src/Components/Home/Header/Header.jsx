...
function Header({ index, title1, title2, title3, form }) {
  return (
    <section
      id={index}
      className="min-h-screen bg-gradient-to-bl  dark:from-dark-BlueNeurons/20 dark:via-gray-800/60 dark:to-gray-800  sm:gap-10 flex justify-center sm:justify-center items-center relative px-5 sm:px-5 md:px-10 lg:px-10 xl:px-40 2xl:px-32 3xl:px-[200px] pt-28 sm:pt-0"
    >
